...
type WarehouseModel struct {
	...
	Products       []*product.ProductModel    `protobuf:"bytes,6,rep,name=products,proto3" json:"products,omitempty"`
}
...
func (x *WarehouseModel) GetProducts() []*product.ProductModel {
	if x != nil {
		return x.Products
	}
	return nil
...
var file_warehouse_warehouse_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0xdc, 0x01, 0x0a, 0x0e, 0x57, 0x61, 0x72, 0x65,
	...
	0x75, 0x6e, 0x74, 0x12, 0x31, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18,
	0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e,
	...
	0x63, 0x74, 0x32, 0xe4, 0x04, 0x0a, 0x10, 0x57, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65,
...
var file_warehouse_warehouse_proto_depIdxs = []int32{
	...
	16, // 9: warehouse.WarehouseModel.products:type_name -> product.ProductModel
