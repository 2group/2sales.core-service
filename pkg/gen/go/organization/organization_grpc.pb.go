...
type OrganizationServiceClient interface {
	...
	CreateBonusLevel(ctx context.Context, in *CreateBonusLevelRequest, opts ...grpc.CallOption) (*CreateBonusLevelResponse, error)
...
func (c *organizationServiceClient) CreateBonusLevel(ctx context.Context, in *CreateBonusLevelRequest, opts ...grpc.CallOption) (*CreateBonusLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateBonusLevelResponse)
...
func (c *organizationServiceClient) GetBonusLevel(ctx context.Context, in *GetBonusLevelRequest, opts ...grpc.CallOption) (*GetBonusLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBonusLevelResponse)
	err := c.cc.Invoke(ctx, OrganizationService_GetBonusLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) UpdateBonusLevel(ctx context.Context, in *UpdateBonusLevelRequest, opts ...grpc.CallOption) (*UpdateBonusLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateBonusLevelResponse)
	err := c.cc.Invoke(ctx, OrganizationService_UpdateBonusLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) ListBonusLevelsByOrganization(ctx context.Context, in *ListBonusLevelsByOrganizationRequest, opts ...grpc.CallOption) (*ListBonusLevelsByOrganizationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListBonusLevelsByOrganizationResponse)
...
type OrganizationServiceServer interface {
	...
	CreateBonusLevel(context.Context, *CreateBonusLevelRequest) (*CreateBonusLevelResponse, error)
...
func (UnimplementedOrganizationServiceServer) CreateBonusLevel(context.Context, *CreateBonusLevelRequest) (*CreateBonusLevelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBonusLevel not implemented")
}
func (UnimplementedOrganizationServiceServer) GetBonusLevel(context.Context, *GetBonusLevelRequest) (*GetBonusLevelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBonusLevel not implemented")
}
func (UnimplementedOrganizationServiceServer) UpdateBonusLevel(context.Context, *UpdateBonusLevelRequest) (*UpdateBonusLevelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBonusLevel not implemented")
}
...
func _OrganizationService_GetBonusLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBonusLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrganizationServiceServer).GetBonusLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrganizationService_GetBonusLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).GetBonusLevel(ctx, req.(*GetBonusLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrganizationService_UpdateBonusLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateBonusLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrganizationServiceServer).UpdateBonusLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrganizationService_UpdateBonusLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).UpdateBonusLevel(ctx, req.(*UpdateBonusLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrganizationService_ListBonusLevelsByOrganization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListBonusLevelsByOrganizationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).ListBonusLevelsByOrganization(ctx, req.(*ListBonusLevelsByOrganizationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrganizationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBonusLevel",
			Handler:    _OrganizationService_GetBonusLevel_Handler,
		},
		{
			MethodName: "UpdateBonusLevel",
			Handler:    _OrganizationService_UpdateBonusLevel_Handler,
		},
		{
