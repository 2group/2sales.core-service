...
func (c *organizationServiceClient) CreateLoyaltyLevel(ctx context.Context, in *CreateLoyaltyLevelRequest, opts ...grpc.CallOption) (*CreateLoyaltyLevelResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrganizationService_CreateLoyaltyLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) GetLoyaltyLevel(ctx context.Context, in *GetLoyaltyLevelRequest, opts ...grpc.CallOption) (*GetLoyaltyLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLoyaltyLevelResponse)
	err := c.cc.Invoke(ctx, OrganizationService_GetLoyaltyLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) UpdateLoyaltyLevel(ctx context.Context, in *UpdateLoyaltyLevelRequest, opts ...grpc.CallOption) (*UpdateLoyaltyLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateLoyaltyLevelResponse)
	err := c.cc.Invoke(ctx, OrganizationService_UpdateLoyaltyLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrganizationServiceServer) GetLoyaltyLevel(context.Context, *GetLoyaltyLevelRequest) (*GetLoyaltyLevelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLoyaltyLevel not implemented")
}
...
func _OrganizationService_CreateLoyaltyLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(OrganizationServiceServer).CreateLoyaltyLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrganizationService_CreateLoyaltyLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).CreateLoyaltyLevel(ctx, req.(*CreateLoyaltyLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrganizationService_GetLoyaltyLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLoyaltyLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrganizationServiceServer).GetLoyaltyLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrganizationService_GetLoyaltyLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).GetLoyaltyLevel(ctx, req.(*GetLoyaltyLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrganizationService_UpdateLoyaltyLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateLoyaltyLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrganizationServiceServer).UpdateLoyaltyLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrganizationService_UpdateLoyaltyLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).UpdateLoyaltyLevel(ctx, req.(*UpdateLoyaltyLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrganizationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrganizationService_CreateLoyaltyLevel_Handler,
		},
		{
			MethodName: "GetLoyaltyLevel",
			Handler:    _OrganizationService_GetLoyaltyLevel_Handler,
		},
		{
			MethodName: "UpdateLoyaltyLevel",
