...
var file_organization_organization_proto_rawDesc = []byte{
	...
	0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x72, 0x0a, 0x1a, 0x55, 0x70,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xd3, 0x0b,
...
var file_organization_organization_proto_depIdxs = []int32{
	...
	2,  // 9: organization.UpdateOrganizationRequest.organization:type_name -> organization.Organization
	2,  // 10: organization.UpdateOrganizationResponse.organization:type_name -> organization.Organization
	...
	5,  // 23: organization.OrganizationService.CreateOrganization:input_type -> organization.CreateOrganizationRequest
	7,  // 24: organization.OrganizationService.GetOrganization:input_type -> organization.GetOrganizationRequest
	9,  // 25: organization.OrganizationService.ListOrganizations:input_type -> organization.ListOrganizationsRequest
	11, // 26: organization.OrganizationService.UpdateOrganization:input_type -> organization.UpdateOrganizationRequest
	13, // 27: organization.OrganizationService.ListBankAccounts:input_type -> organization.ListBankAccountsRequest
	15, // 28: organization.OrganizationService.GetDefaultBankAccount:input_type -> organization.GetDefaultBankAccountRequest
	17, // 29: organization.OrganizationService.CreateBankAccount:input_type -> organization.CreateBankAccountRequest
	19, // 30: organization.OrganizationService.UpdateBankAccount:input_type -> organization.UpdateBankAccountRequest
	21, // 31: organization.OrganizationService.PatchBankAccount:input_type -> organization.PatchBankAccountRequest
	23, // 32: organization.OrganizationService.DeleteBankAccount:input_type -> organization.DeleteBankAccountRequest
	25, // 33: organization.OrganizationService.GetBankAccount:input_type -> organization.GetBankAccountRequest
	27, // 34: organization.OrganizationService.CreateAddress:input_type -> organization.CreateAddressRequest
	29, // 35: organization.OrganizationService.GetAddress:input_type -> organization.GetAddressRequest
	31, // 36: organization.OrganizationService.UpdateAddress:input_type -> organization.UpdateAddressRequest
	33, // 37: organization.OrganizationService.DeleteAddress:input_type -> organization.DeleteAddressRequest
	6,  // 38: organization.OrganizationService.CreateOrganization:output_type -> organization.CreateOrganizationResponse
	8,  // 39: organization.OrganizationService.GetOrganization:output_type -> organization.GetOrganizationResponse
	10, // 40: organization.OrganizationService.ListOrganizations:output_type -> organization.ListOrganizationsResponse
	12, // 41: organization.OrganizationService.UpdateOrganization:output_type -> organization.UpdateOrganizationResponse
	14, // 42: organization.OrganizationService.ListBankAccounts:output_type -> organization.ListBankAccountsResponse
	16, // 43: organization.OrganizationService.GetDefaultBankAccount:output_type -> organization.GetDefaultBankAccountResponse
	18, // 44: organization.OrganizationService.CreateBankAccount:output_type -> organization.CreateBankAccountResponse
	20, // 45: organization.OrganizationService.UpdateBankAccount:output_type -> organization.UpdateBankAccountResponse
	22, // 46: organization.OrganizationService.PatchBankAccount:output_type -> organization.PatchBankAccountResponse
	24, // 47: organization.OrganizationService.DeleteBankAccount:output_type -> organization.DeleteBankAccountResponse
	26, // 48: organization.OrganizationService.GetBankAccount:output_type -> organization.GetBankAccountResponse
	28, // 49: organization.OrganizationService.CreateAddress:output_type -> organization.CreateAddressResponse
	30, // 50: organization.OrganizationService.GetAddress:output_type -> organization.GetAddressResponse
	32, // 51: organization.OrganizationService.UpdateAddress:output_type -> organization.UpdateAddressResponse
	34, // 52: organization.OrganizationService.DeleteAddress:output_type -> organization.DeleteAddressResponse
