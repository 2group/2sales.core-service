...
var file_organization_organization_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x5b, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x61, 0x6e,
	...
	0x52, 0x0c, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x86,
	...
	0x65, 0x22, 0x83, 0x01, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69,
	...
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x0d, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a,
	...
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x42, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x61,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xd0, 0x0b, 0x0a, 0x13, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69,
...
var file_organization_organization_proto_depIdxs = []int32{
	...
	2,  // 4: organization.CreateOrganizationRequest.organization:type_name -> organization.Organization
	3,  // 5: organization.CreateOrganizationResponse.organization:type_name -> organization.OrganizationModel
	2,  // 6: organization.GetOrganizationResponse.organization:type_name -> organization.Organization
	3,  // 7: organization.ListOrganizationsResponse.organizations:type_name -> organization.OrganizationModel
	2,  // 8: organization.PatchOrganizationRequest.organization:type_name -> organization.Organization
	2,  // 9: organization.PatchOrganizationResponse.organization:type_name -> organization.Organization
	...
	13, // 26: organization.OrganizationService.ListBankAccounts:input_type -> organization.ListBankAccountsRequest
	15, // 27: organization.OrganizationService.GetDefaultBankAccount:input_type -> organization.GetDefaultBankAccountRequest
	17, // 28: organization.OrganizationService.CreateBankAccount:input_type -> organization.CreateBankAccountRequest
	19, // 29: organization.OrganizationService.UpdateBankAccount:input_type -> organization.UpdateBankAccountRequest
	21, // 30: organization.OrganizationService.PatchBankAccount:input_type -> organization.PatchBankAccountRequest
	23, // 31: organization.OrganizationService.DeleteBankAccount:input_type -> organization.DeleteBankAccountRequest
	25, // 32: organization.OrganizationService.GetBankAccount:input_type -> organization.GetBankAccountRequest
	27, // 33: organization.OrganizationService.CreateAddress:input_type -> organization.CreateAddressRequest
	29, // 34: organization.OrganizationService.GetAddress:input_type -> organization.GetAddressRequest
	31, // 35: organization.OrganizationService.UpdateAddress:input_type -> organization.UpdateAddressRequest
	33, // 36: organization.OrganizationService.DeleteAddress:input_type -> organization.DeleteAddressRequest
	6,  // 37: organization.OrganizationService.CreateOrganization:output_type -> organization.CreateOrganizationResponse
	8,  // 38: organization.OrganizationService.GetOrganization:output_type -> organization.GetOrganizationResponse
	10, // 39: organization.OrganizationService.ListOrganizations:output_type -> organization.ListOrganizationsResponse
	12, // 40: organization.OrganizationService.PatchOrganization:output_type -> organization.PatchOrganizationResponse
	14, // 41: organization.OrganizationService.ListBankAccounts:output_type -> organization.ListBankAccountsResponse
	16, // 42: organization.OrganizationService.GetDefaultBankAccount:output_type -> organization.GetDefaultBankAccountResponse
	18, // 43: organization.OrganizationService.CreateBankAccount:output_type -> organization.CreateBankAccountResponse
	20, // 44: organization.OrganizationService.UpdateBankAccount:output_type -> organization.UpdateBankAccountResponse
	22, // 45: organization.OrganizationService.PatchBankAccount:output_type -> organization.PatchBankAccountResponse
	24, // 46: organization.OrganizationService.DeleteBankAccount:output_type -> organization.DeleteBankAccountResponse
	26, // 47: organization.OrganizationService.GetBankAccount:output_type -> organization.GetBankAccountResponse
	28, // 48: organization.OrganizationService.CreateAddress:output_type -> organization.CreateAddressResponse
	30, // 49: organization.OrganizationService.GetAddress:output_type -> organization.GetAddressResponse
	32, // 50: organization.OrganizationService.UpdateAddress:output_type -> organization.UpdateAddressResponse
	34, // 51: organization.OrganizationService.DeleteAddress:output_type -> organization.DeleteAddressResponse
