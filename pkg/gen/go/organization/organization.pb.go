...
var file_organization_organization_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x69, 0x73, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x22, 0x85, 0x01, 0x0a, 0x19,
	...
	0x63, 0x65, 0x73, 0x73, 0x32, 0xb9, 0x0c, 0x0a, 0x13, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a,
...
var file_organization_organization_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_organization_organization_proto_goTypes = []any{
	...
	(*PatchOrganizationRequest)(nil),      // 11: organization.PatchOrganizationRequest
	(*PatchOrganizationResponse)(nil),     // 12: organization.PatchOrganizationResponse
	...
	(*ListBankAccountsRequest)(nil),       // 15: organization.ListBankAccountsRequest
	(*ListBankAccountsResponse)(nil),      // 16: organization.ListBankAccountsResponse
	(*GetDefaultBankAccountRequest)(nil),  // 17: organization.GetDefaultBankAccountRequest
	(*GetDefaultBankAccountResponse)(nil), // 18: organization.GetDefaultBankAccountResponse
	(*CreateBankAccountRequest)(nil),      // 19: organization.CreateBankAccountRequest
	(*CreateBankAccountResponse)(nil),     // 20: organization.CreateBankAccountResponse
	(*UpdateBankAccountRequest)(nil),      // 21: organization.UpdateBankAccountRequest
	(*UpdateBankAccountResponse)(nil),     // 22: organization.UpdateBankAccountResponse
	(*PatchBankAccountRequest)(nil),       // 23: organization.PatchBankAccountRequest
	(*PatchBankAccountResponse)(nil),      // 24: organization.PatchBankAccountResponse
	(*DeleteBankAccountRequest)(nil),      // 25: organization.DeleteBankAccountRequest
	(*DeleteBankAccountResponse)(nil),     // 26: organization.DeleteBankAccountResponse
	(*GetBankAccountRequest)(nil),         // 27: organization.GetBankAccountRequest
	(*GetBankAccountResponse)(nil),        // 28: organization.GetBankAccountResponse
	(*CreateAddressRequest)(nil),          // 29: organization.CreateAddressRequest
	(*CreateAddressResponse)(nil),         // 30: organization.CreateAddressResponse
	(*GetAddressRequest)(nil),             // 31: organization.GetAddressRequest
	(*GetAddressResponse)(nil),            // 32: organization.GetAddressResponse
	(*UpdateAddressRequest)(nil),          // 33: organization.UpdateAddressRequest
	(*UpdateAddressResponse)(nil),         // 34: organization.UpdateAddressResponse
	(*DeleteAddressRequest)(nil),          // 35: organization.DeleteAddressRequest
	(*DeleteAddressResponse)(nil),         // 36: organization.DeleteAddressResponse
}
var file_organization_organization_proto_depIdxs = []int32{
	...
	5,  // 22: organization.OrganizationService.CreateOrganization:input_type -> organization.CreateOrganizationRequest
	7,  // 23: organization.OrganizationService.GetOrganization:input_type -> organization.GetOrganizationRequest
	9,  // 24: organization.OrganizationService.ListOrganizations:input_type -> organization.ListOrganizationsRequest
	11, // 25: organization.OrganizationService.PatchOrganization:input_type -> organization.PatchOrganizationRequest
	13, // 26: organization.OrganizationService.UpdateOrganization:input_type -> organization.UpdateOrganizationRequest
	15, // 27: organization.OrganizationService.ListBankAccounts:input_type -> organization.ListBankAccountsRequest
	17, // 28: organization.OrganizationService.GetDefaultBankAccount:input_type -> organization.GetDefaultBankAccountRequest
	19, // 29: organization.OrganizationService.CreateBankAccount:input_type -> organization.CreateBankAccountRequest
	21, // 30: organization.OrganizationService.UpdateBankAccount:input_type -> organization.UpdateBankAccountRequest
	23, // 31: organization.OrganizationService.PatchBankAccount:input_type -> organization.PatchBankAccountRequest
	25, // 32: organization.OrganizationService.DeleteBankAccount:input_type -> organization.DeleteBankAccountRequest
	27, // 33: organization.OrganizationService.GetBankAccount:input_type -> organization.GetBankAccountRequest
	29, // 34: organization.OrganizationService.CreateAddress:input_type -> organization.CreateAddressRequest
	31, // 35: organization.OrganizationService.GetAddress:input_type -> organization.GetAddressRequest
	33, // 36: organization.OrganizationService.UpdateAddress:input_type -> organization.UpdateAddressRequest
	35, // 37: organization.OrganizationService.DeleteAddress:input_type -> organization.DeleteAddressRequest
	...
	12, // 41: organization.OrganizationService.PatchOrganization:output_type -> organization.PatchOrganizationResponse
	14, // 42: organization.OrganizationService.UpdateOrganization:output_type -> organization.UpdateOrganizationResponse
	16, // 43: organization.OrganizationService.ListBankAccounts:output_type -> organization.ListBankAccountsResponse
	18, // 44: organization.OrganizationService.GetDefaultBankAccount:output_type -> organization.GetDefaultBankAccountResponse
	20, // 45: organization.OrganizationService.CreateBankAccount:output_type -> organization.CreateBankAccountResponse
	22, // 46: organization.OrganizationService.UpdateBankAccount:output_type -> organization.UpdateBankAccountResponse
	24, // 47: organization.OrganizationService.PatchBankAccount:output_type -> organization.PatchBankAccountResponse
	26, // 48: organization.OrganizationService.DeleteBankAccount:output_type -> organization.DeleteBankAccountResponse
	28, // 49: organization.OrganizationService.GetBankAccount:output_type -> organization.GetBankAccountResponse
	30, // 50: organization.OrganizationService.CreateAddress:output_type -> organization.CreateAddressResponse
	32, // 51: organization.OrganizationService.GetAddress:output_type -> organization.GetAddressResponse
	34, // 52: organization.OrganizationService.UpdateAddress:output_type -> organization.UpdateAddressResponse
	36, // 53: organization.OrganizationService.DeleteAddress:output_type -> organization.DeleteAddressResponse
