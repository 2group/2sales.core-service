...
var file_organization_organization_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x68, 0x69, 0x70, 0x22, 0x2c, 0x0a, 0x1a, 0x47,
	...
	0x6e, 0x49, 0x64, 0x22, 0x71, 0x0a, 0x1d, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x6c, 0x61, 0x74,
	...
	0x73, 0x68, 0x69, 0x70, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x22, 0x71, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x68, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65,
	...
	0x54, 0x79, 0x70, 0x65, 0x32, 0xd3, 0x11, 0x0a, 0x13, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a,
	...
	0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x67, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69,
	...
	0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x67, 0x0a, 0x12, 0x55, 0x70, 0x64,
	...
	0x70, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x4e, 0x5a, 0x4c, 0x67, 0x69,
...
var file_organization_organization_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_organization_organization_proto_goTypes = []any{
	...
	(*GetRelationshipTypeRequest)(nil),     // 43: organization.GetRelationshipTypeRequest
	(*GetRelationshipTypeResponse)(nil),    // 44: organization.GetRelationshipTypeResponse
	(*ListRelationshipTypesRequest)(nil),   // 45: organization.ListRelationshipTypesRequest
	(*ListRelationshipTypesResponse)(nil),  // 46: organization.ListRelationshipTypesResponse
	(*CreateRelationshipTypeRequest)(nil),  // 47: organization.CreateRelationshipTypeRequest
	(*CreateRelationshipTypeResponse)(nil), // 48: organization.CreateRelationshipTypeResponse
	(*UpdateRelationshipTypeRequest)(nil),  // 49: organization.UpdateRelationshipTypeRequest
	(*UpdateRelationshipTypeResponse)(nil), // 50: organization.UpdateRelationshipTypeResponse
}
var file_organization_organization_proto_depIdxs = []int32{
	...
	5,  // 26: organization.GetRelationshipTypeResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 27: organization.ListRelationshipTypesResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 28: organization.CreateRelationshipTypeRequest.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 29: organization.CreateRelationshipTypeResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 30: organization.UpdateRelationshipTypeRequest.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 31: organization.UpdateRelationshipTypeResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	7,  // 32: organization.OrganizationService.CreateOrganization:input_type -> organization.CreateOrganizationRequest
	9,  // 33: organization.OrganizationService.GetOrganization:input_type -> organization.GetOrganizationRequest
	11, // 34: organization.OrganizationService.ListOrganizations:input_type -> organization.ListOrganizationsRequest
	13, // 35: organization.OrganizationService.PatchOrganization:input_type -> organization.PatchOrganizationRequest
	15, // 36: organization.OrganizationService.UpdateOrganization:input_type -> organization.UpdateOrganizationRequest
	17, // 37: organization.OrganizationService.ListBankAccounts:input_type -> organization.ListBankAccountsRequest
	19, // 38: organization.OrganizationService.GetDefaultBankAccount:input_type -> organization.GetDefaultBankAccountRequest
	21, // 39: organization.OrganizationService.CreateBankAccount:input_type -> organization.CreateBankAccountRequest
	23, // 40: organization.OrganizationService.UpdateBankAccount:input_type -> organization.UpdateBankAccountRequest
	25, // 41: organization.OrganizationService.PatchBankAccount:input_type -> organization.PatchBankAccountRequest
	27, // 42: organization.OrganizationService.DeleteBankAccount:input_type -> organization.DeleteBankAccountRequest
	29, // 43: organization.OrganizationService.GetBankAccount:input_type -> organization.GetBankAccountRequest
	31, // 44: organization.OrganizationService.CreateAddress:input_type -> organization.CreateAddressRequest
	33, // 45: organization.OrganizationService.GetAddress:input_type -> organization.GetAddressRequest
	35, // 46: organization.OrganizationService.UpdateAddress:input_type -> organization.UpdateAddressRequest
	37, // 47: organization.OrganizationService.DeleteAddress:input_type -> organization.DeleteAddressRequest
	39, // 48: organization.OrganizationService.CreateRelationship:input_type -> organization.CreateRelationshipRequest
	41, // 49: organization.OrganizationService.UpdateRelationship:input_type -> organization.UpdateRelationshipRequest
	43, // 50: organization.OrganizationService.GetRelationshipType:input_type -> organization.GetRelationshipTypeRequest
	45, // 51: organization.OrganizationService.ListRelationshipTypes:input_type -> organization.ListRelationshipTypesRequest
	47, // 52: organization.OrganizationService.CreateRelationshipType:input_type -> organization.CreateRelationshipTypeRequest
	49, // 53: organization.OrganizationService.UpdateRelationshipType:input_type -> organization.UpdateRelationshipTypeRequest
	8,  // 54: organization.OrganizationService.CreateOrganization:output_type -> organization.CreateOrganizationResponse
	10, // 55: organization.OrganizationService.GetOrganization:output_type -> organization.GetOrganizationResponse
	12, // 56: organization.OrganizationService.ListOrganizations:output_type -> organization.ListOrganizationsResponse
	14, // 57: organization.OrganizationService.PatchOrganization:output_type -> organization.PatchOrganizationResponse
	16, // 58: organization.OrganizationService.UpdateOrganization:output_type -> organization.UpdateOrganizationResponse
	18, // 59: organization.OrganizationService.ListBankAccounts:output_type -> organization.ListBankAccountsResponse
	20, // 60: organization.OrganizationService.GetDefaultBankAccount:output_type -> organization.GetDefaultBankAccountResponse
	22, // 61: organization.OrganizationService.CreateBankAccount:output_type -> organization.CreateBankAccountResponse
	24, // 62: organization.OrganizationService.UpdateBankAccount:output_type -> organization.UpdateBankAccountResponse
	26, // 63: organization.OrganizationService.PatchBankAccount:output_type -> organization.PatchBankAccountResponse
	28, // 64: organization.OrganizationService.DeleteBankAccount:output_type -> organization.DeleteBankAccountResponse
	30, // 65: organization.OrganizationService.GetBankAccount:output_type -> organization.GetBankAccountResponse
	32, // 66: organization.OrganizationService.CreateAddress:output_type -> organization.CreateAddressResponse
	34, // 67: organization.OrganizationService.GetAddress:output_type -> organization.GetAddressResponse
	36, // 68: organization.OrganizationService.UpdateAddress:output_type -> organization.UpdateAddressResponse
	38, // 69: organization.OrganizationService.DeleteAddress:output_type -> organization.DeleteAddressResponse
	40, // 70: organization.OrganizationService.CreateRelationship:output_type -> organization.CreateRelationshipResponse
	42, // 71: organization.OrganizationService.UpdateRelationship:output_type -> organization.UpdateRelationshipResponse
	44, // 72: organization.OrganizationService.GetRelationshipType:output_type -> organization.GetRelationshipTypeResponse
	46, // 73: organization.OrganizationService.ListRelationshipTypes:output_type -> organization.ListRelationshipTypesResponse
	48, // 74: organization.OrganizationService.CreateRelationshipType:output_type -> organization.CreateRelationshipTypeResponse
	50, // 75: organization.OrganizationService.UpdateRelationshipType:output_type -> organization.UpdateRelationshipTypeResponse
