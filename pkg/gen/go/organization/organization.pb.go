...
var file_organization_organization_proto_rawDesc = []byte{
	...
	0xdf, 0x02, 0x0a, 0x0c, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	...
	0x5f, 0x69, 0x64, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x07, 0x0a,
	...
	0x65, 0x22, 0x46, 0x0a, 0x0a, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12,
	0x10, 0x0a, 0x03, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x69, 0x6e,
	...
	0x28, 0x03, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x83, 0x04, 0x0a, 0x0c, 0x4f, 0x72,
	...
	0x70, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x19,
	...
	0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x73, 0x0a, 0x18,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x42, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x61, 0x6e,
	...
	0x6e, 0x73, 0x68, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x32, 0x8b, 0x14, 0x0a, 0x13, 0x4f, 0x72,
...
var file_organization_organization_proto_goTypes = []any{
	...
	(*CreateOrganizationRequest)(nil),        // 8: organization.CreateOrganizationRequest
	(*CreateOrganizationResponse)(nil),       // 9: organization.CreateOrganizationResponse
	(*GetOrganizationRequest)(nil),           // 10: organization.GetOrganizationRequest
	(*GetOrganizationResponse)(nil),          // 11: organization.GetOrganizationResponse
	(*ListOrganizationsRequest)(nil),         // 12: organization.ListOrganizationsRequest
	(*ListOrganizationsResponse)(nil),        // 13: organization.ListOrganizationsResponse
	(*PatchOrganizationRequest)(nil),         // 14: organization.PatchOrganizationRequest
	(*PatchOrganizationResponse)(nil),        // 15: organization.PatchOrganizationResponse
	(*UpdateOrganizationRequest)(nil),        // 16: organization.UpdateOrganizationRequest
	(*UpdateOrganizationResponse)(nil),       // 17: organization.UpdateOrganizationResponse
	(*ListBankAccountsRequest)(nil),          // 18: organization.ListBankAccountsRequest
	(*ListBankAccountsResponse)(nil),         // 19: organization.ListBankAccountsResponse
	(*GetDefaultBankAccountRequest)(nil),     // 20: organization.GetDefaultBankAccountRequest
	(*GetDefaultBankAccountResponse)(nil),    // 21: organization.GetDefaultBankAccountResponse
	(*CreateBankAccountRequest)(nil),         // 22: organization.CreateBankAccountRequest
	(*CreateBankAccountResponse)(nil),        // 23: organization.CreateBankAccountResponse
	(*UpdateBankAccountRequest)(nil),         // 24: organization.UpdateBankAccountRequest
	(*UpdateBankAccountResponse)(nil),        // 25: organization.UpdateBankAccountResponse
	(*PatchBankAccountRequest)(nil),          // 26: organization.PatchBankAccountRequest
	(*PatchBankAccountResponse)(nil),         // 27: organization.PatchBankAccountResponse
	(*DeleteBankAccountRequest)(nil),         // 28: organization.DeleteBankAccountRequest
	(*DeleteBankAccountResponse)(nil),        // 29: organization.DeleteBankAccountResponse
	(*GetBankAccountRequest)(nil),            // 30: organization.GetBankAccountRequest
	(*GetBankAccountResponse)(nil),           // 31: organization.GetBankAccountResponse
	(*CreateAddressRequest)(nil),             // 32: organization.CreateAddressRequest
	(*CreateAddressResponse)(nil),            // 33: organization.CreateAddressResponse
	(*GetAddressRequest)(nil),                // 34: organization.GetAddressRequest
	(*GetAddressResponse)(nil),               // 35: organization.GetAddressResponse
	(*UpdateAddressRequest)(nil),             // 36: organization.UpdateAddressRequest
	(*UpdateAddressResponse)(nil),            // 37: organization.UpdateAddressResponse
	(*PatchAddressRequest)(nil),              // 38: organization.PatchAddressRequest
	(*PatchAddressResponse)(nil),             // 39: organization.PatchAddressResponse
	(*DeleteAddressRequest)(nil),             // 40: organization.DeleteAddressRequest
	(*DeleteAddressResponse)(nil),            // 41: organization.DeleteAddressResponse
	(*CreateRelationshipRequest)(nil),        // 42: organization.CreateRelationshipRequest
	(*CreateRelationshipResponse)(nil),       // 43: organization.CreateRelationshipResponse
	(*UpdateRelationshipRequest)(nil),        // 44: organization.UpdateRelationshipRequest
	(*UpdateRelationshipResponse)(nil),       // 45: organization.UpdateRelationshipResponse
	(*EnsureRelationshipExistsRequest)(nil),  // 46: organization.EnsureRelationshipExistsRequest
	(*EnsureRelationshipExistsResponse)(nil), // 47: organization.EnsureRelationshipExistsResponse
	(*ListRelationshipsRequest)(nil),         // 48: organization.ListRelationshipsRequest
	(*ListRelationshipsResponse)(nil),        // 49: organization.ListRelationshipsResponse
	(*GetRelationshipTypeRequest)(nil),       // 50: organization.GetRelationshipTypeRequest
	(*GetRelationshipTypeResponse)(nil),      // 51: organization.GetRelationshipTypeResponse
	(*ListRelationshipTypesRequest)(nil),     // 52: organization.ListRelationshipTypesRequest
	(*ListRelationshipTypesResponse)(nil),    // 53: organization.ListRelationshipTypesResponse
	(*CreateRelationshipTypeRequest)(nil),    // 54: organization.CreateRelationshipTypeRequest
	(*CreateRelationshipTypeResponse)(nil),   // 55: organization.CreateRelationshipTypeResponse
	(*UpdateRelationshipTypeRequest)(nil),    // 56: organization.UpdateRelationshipTypeRequest
	(*UpdateRelationshipTypeResponse)(nil),   // 57: organization.UpdateRelationshipTypeResponse
}
var file_organization_organization_proto_depIdxs = []int32{
	...
	8,  // 37: organization.OrganizationService.CreateOrganization:input_type -> organization.CreateOrganizationRequest
	10, // 38: organization.OrganizationService.GetOrganization:input_type -> organization.GetOrganizationRequest
	12, // 39: organization.OrganizationService.ListOrganizations:input_type -> organization.ListOrganizationsRequest
	14, // 40: organization.OrganizationService.PatchOrganization:input_type -> organization.PatchOrganizationRequest
	16, // 41: organization.OrganizationService.UpdateOrganization:input_type -> organization.UpdateOrganizationRequest
	18, // 42: organization.OrganizationService.ListBankAccounts:input_type -> organization.ListBankAccountsRequest
	20, // 43: organization.OrganizationService.GetDefaultBankAccount:input_type -> organization.GetDefaultBankAccountRequest
	22, // 44: organization.OrganizationService.CreateBankAccount:input_type -> organization.CreateBankAccountRequest
	24, // 45: organization.OrganizationService.UpdateBankAccount:input_type -> organization.UpdateBankAccountRequest
	26, // 46: organization.OrganizationService.PatchBankAccount:input_type -> organization.PatchBankAccountRequest
	28, // 47: organization.OrganizationService.DeleteBankAccount:input_type -> organization.DeleteBankAccountRequest
	30, // 48: organization.OrganizationService.GetBankAccount:input_type -> organization.GetBankAccountRequest
	32, // 49: organization.OrganizationService.CreateAddress:input_type -> organization.CreateAddressRequest
	34, // 50: organization.OrganizationService.GetAddress:input_type -> organization.GetAddressRequest
	36, // 51: organization.OrganizationService.UpdateAddress:input_type -> organization.UpdateAddressRequest
	38, // 52: organization.OrganizationService.PatchAddress:input_type -> organization.PatchAddressRequest
	40, // 53: organization.OrganizationService.DeleteAddress:input_type -> organization.DeleteAddressRequest
	42, // 54: organization.OrganizationService.CreateRelationship:input_type -> organization.CreateRelationshipRequest
	48, // 55: organization.OrganizationService.ListRelationships:input_type -> organization.ListRelationshipsRequest
	46, // 56: organization.OrganizationService.EnsureRelationshipExists:input_type -> organization.EnsureRelationshipExistsRequest
	44, // 57: organization.OrganizationService.UpdateRelationship:input_type -> organization.UpdateRelationshipRequest
	50, // 58: organization.OrganizationService.GetRelationshipType:input_type -> organization.GetRelationshipTypeRequest
	52, // 59: organization.OrganizationService.ListRelationshipTypes:input_type -> organization.ListRelationshipTypesRequest
	54, // 60: organization.OrganizationService.CreateRelationshipType:input_type -> organization.CreateRelationshipTypeRequest
	56, // 61: organization.OrganizationService.UpdateRelationshipType:input_type -> organization.UpdateRelationshipTypeRequest
	9,  // 62: organization.OrganizationService.CreateOrganization:output_type -> organization.CreateOrganizationResponse
	11, // 63: organization.OrganizationService.GetOrganization:output_type -> organization.GetOrganizationResponse
	13, // 64: organization.OrganizationService.ListOrganizations:output_type -> organization.ListOrganizationsResponse
	15, // 65: organization.OrganizationService.PatchOrganization:output_type -> organization.PatchOrganizationResponse
	17, // 66: organization.OrganizationService.UpdateOrganization:output_type -> organization.UpdateOrganizationResponse
	19, // 67: organization.OrganizationService.ListBankAccounts:output_type -> organization.ListBankAccountsResponse
	21, // 68: organization.OrganizationService.GetDefaultBankAccount:output_type -> organization.GetDefaultBankAccountResponse
	23, // 69: organization.OrganizationService.CreateBankAccount:output_type -> organization.CreateBankAccountResponse
	25, // 70: organization.OrganizationService.UpdateBankAccount:output_type -> organization.UpdateBankAccountResponse
	27, // 71: organization.OrganizationService.PatchBankAccount:output_type -> organization.PatchBankAccountResponse
	29, // 72: organization.OrganizationService.DeleteBankAccount:output_type -> organization.DeleteBankAccountResponse
	31, // 73: organization.OrganizationService.GetBankAccount:output_type -> organization.GetBankAccountResponse
	33, // 74: organization.OrganizationService.CreateAddress:output_type -> organization.CreateAddressResponse
	35, // 75: organization.OrganizationService.GetAddress:output_type -> organization.GetAddressResponse
	37, // 76: organization.OrganizationService.UpdateAddress:output_type -> organization.UpdateAddressResponse
	39, // 77: organization.OrganizationService.PatchAddress:output_type -> organization.PatchAddressResponse
	41, // 78: organization.OrganizationService.DeleteAddress:output_type -> organization.DeleteAddressResponse
	43, // 79: organization.OrganizationService.CreateRelationship:output_type -> organization.CreateRelationshipResponse
	49, // 80: organization.OrganizationService.ListRelationships:output_type -> organization.ListRelationshipsResponse
	47, // 81: organization.OrganizationService.EnsureRelationshipExists:output_type -> organization.EnsureRelationshipExistsResponse
	45, // 82: organization.OrganizationService.UpdateRelationship:output_type -> organization.UpdateRelationshipResponse
	51, // 83: organization.OrganizationService.GetRelationshipType:output_type -> organization.GetRelationshipTypeResponse
	53, // 84: organization.OrganizationService.ListRelationshipTypes:output_type -> organization.ListRelationshipTypesResponse
	55, // 85: organization.OrganizationService.CreateRelationshipType:output_type -> organization.CreateRelationshipTypeResponse
	57, // 86: organization.OrganizationService.UpdateRelationshipType:output_type -> organization.UpdateRelationshipTypeResponse
