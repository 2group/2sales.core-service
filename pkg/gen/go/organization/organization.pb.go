...
type ListRelationshipTypesRequest struct {
	...
	OrganizaitonId int64 `protobuf:"varint,1,opt,name=organizaiton_id,json=organizaitonId,proto3" json:"organizaiton_id,omitempty"`
}
...
func (x *ListRelationshipTypesRequest) GetOrganizaitonId() int64 {
	if x != nil {
		return x.OrganizaitonId
	}
	return 0
}
...
var file_organization_organization_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x68, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x22, 0x47, 0x0a, 0x1c,
	...
	0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x69, 0x74, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x69,
	0x74, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x71, 0x0a, 0x1d, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x6c,
	...
	0x6f, 0x6e, 0x73, 0x68, 0x69, 0x70, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	0x73, 0x68, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x22, 0x71, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61,
	...
	0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x32, 0x81, 0x10, 0x0a, 0x13, 0x4f, 0x72, 0x67, 0x61, 0x6e,
...
var file_organization_organization_proto_goTypes = []any{
	...
	(*ListRelationshipTypesRequest)(nil),   // 40: organization.ListRelationshipTypesRequest
	(*ListRelationshipTypesResponse)(nil),  // 41: organization.ListRelationshipTypesResponse
	(*CreateRelationshipTypeRequest)(nil),  // 42: organization.CreateRelationshipTypeRequest
	(*CreateRelationshipTypeResponse)(nil), // 43: organization.CreateRelationshipTypeResponse
	(*UpdateRelationshipTypeRequest)(nil),  // 44: organization.UpdateRelationshipTypeRequest
	(*UpdateRelationshipTypeResponse)(nil), // 45: organization.UpdateRelationshipTypeResponse
}
var file_organization_organization_proto_depIdxs = []int32{
	...
	5,  // 23: organization.ListRelationshipTypesResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 24: organization.CreateRelationshipTypeRequest.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 25: organization.CreateRelationshipTypeResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 26: organization.UpdateRelationshipTypeRequest.relationship_type:type_name -> organization.RelationshipTypeModel
	5,  // 27: organization.UpdateRelationshipTypeResponse.relationship_type:type_name -> organization.RelationshipTypeModel
	6,  // 28: organization.OrganizationService.CreateOrganization:input_type -> organization.CreateOrganizationRequest
	8,  // 29: organization.OrganizationService.GetOrganization:input_type -> organization.GetOrganizationRequest
	10, // 30: organization.OrganizationService.ListOrganizations:input_type -> organization.ListOrganizationsRequest
	12, // 31: organization.OrganizationService.PatchOrganization:input_type -> organization.PatchOrganizationRequest
	14, // 32: organization.OrganizationService.UpdateOrganization:input_type -> organization.UpdateOrganizationRequest
	16, // 33: organization.OrganizationService.ListBankAccounts:input_type -> organization.ListBankAccountsRequest
	18, // 34: organization.OrganizationService.GetDefaultBankAccount:input_type -> organization.GetDefaultBankAccountRequest
	20, // 35: organization.OrganizationService.CreateBankAccount:input_type -> organization.CreateBankAccountRequest
	22, // 36: organization.OrganizationService.UpdateBankAccount:input_type -> organization.UpdateBankAccountRequest
	24, // 37: organization.OrganizationService.PatchBankAccount:input_type -> organization.PatchBankAccountRequest
	26, // 38: organization.OrganizationService.DeleteBankAccount:input_type -> organization.DeleteBankAccountRequest
	28, // 39: organization.OrganizationService.GetBankAccount:input_type -> organization.GetBankAccountRequest
	30, // 40: organization.OrganizationService.CreateAddress:input_type -> organization.CreateAddressRequest
	32, // 41: organization.OrganizationService.GetAddress:input_type -> organization.GetAddressRequest
	34, // 42: organization.OrganizationService.UpdateAddress:input_type -> organization.UpdateAddressRequest
	36, // 43: organization.OrganizationService.DeleteAddress:input_type -> organization.DeleteAddressRequest
	38, // 44: organization.OrganizationService.GetRelationshipType:input_type -> organization.GetRelationshipTypeRequest
	40, // 45: organization.OrganizationService.ListRelationshipTypes:input_type -> organization.ListRelationshipTypesRequest
	42, // 46: organization.OrganizationService.CreateRelationshipType:input_type -> organization.CreateRelationshipTypeRequest
	44, // 47: organization.OrganizationService.UpdateRelationshipType:input_type -> organization.UpdateRelationshipTypeRequest
	7,  // 48: organization.OrganizationService.CreateOrganization:output_type -> organization.CreateOrganizationResponse
	9,  // 49: organization.OrganizationService.GetOrganization:output_type -> organization.GetOrganizationResponse
	11, // 50: organization.OrganizationService.ListOrganizations:output_type -> organization.ListOrganizationsResponse
	13, // 51: organization.OrganizationService.PatchOrganization:output_type -> organization.PatchOrganizationResponse
	15, // 52: organization.OrganizationService.UpdateOrganization:output_type -> organization.UpdateOrganizationResponse
	17, // 53: organization.OrganizationService.ListBankAccounts:output_type -> organization.ListBankAccountsResponse
	19, // 54: organization.OrganizationService.GetDefaultBankAccount:output_type -> organization.GetDefaultBankAccountResponse
	21, // 55: organization.OrganizationService.CreateBankAccount:output_type -> organization.CreateBankAccountResponse
	23, // 56: organization.OrganizationService.UpdateBankAccount:output_type -> organization.UpdateBankAccountResponse
	25, // 57: organization.OrganizationService.PatchBankAccount:output_type -> organization.PatchBankAccountResponse
	27, // 58: organization.OrganizationService.DeleteBankAccount:output_type -> organization.DeleteBankAccountResponse
	29, // 59: organization.OrganizationService.GetBankAccount:output_type -> organization.GetBankAccountResponse
	31, // 60: organization.OrganizationService.CreateAddress:output_type -> organization.CreateAddressResponse
	33, // 61: organization.OrganizationService.GetAddress:output_type -> organization.GetAddressResponse
	35, // 62: organization.OrganizationService.UpdateAddress:output_type -> organization.UpdateAddressResponse
	37, // 63: organization.OrganizationService.DeleteAddress:output_type -> organization.DeleteAddressResponse
	39, // 64: organization.OrganizationService.GetRelationshipType:output_type -> organization.GetRelationshipTypeResponse
	41, // 65: organization.OrganizationService.ListRelationshipTypes:output_type -> organization.ListRelationshipTypesResponse
	43, // 66: organization.OrganizationService.CreateRelationshipType:output_type -> organization.CreateRelationshipTypeResponse
	45, // 67: organization.OrganizationService.UpdateRelationshipType:output_type -> organization.UpdateRelationshipTypeResponse
