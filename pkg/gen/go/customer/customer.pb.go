...
const file_customer_customer_proto_rawDesc = "" +
	...
	"\x11_loyalty_level_id\"\x1a\n" +
	"\x18CustomerBonusTransaction\"\x10\n" +
	"\x0eCustomerDetail\"p\n" +
	...
	"\fbonus_change\x18\x04 \x01(\x01R\vbonusChange\" \n" +
	"\x1eCreateBonusTransactionResponse\"9\n" +
	"\x16GetBonusBalanceRequest\x12\x1f\n" +
	"\vcustomer_id\x18\x01 \x01(\x03R\n" +
	"customerId\"3\n" +
	"\x17GetBonusBalanceResponse\x12\x18\n" +
	"\abalance\x18\x01 \x01(\x01R\abalance2\xb3\x04\n" +
...
var file_customer_customer_proto_goTypes = []any{
	...
	(*GetBonusBalanceRequest)(nil),         // 15: customer.GetBonusBalanceRequest
	(*GetBonusBalanceResponse)(nil),        // 16: customer.GetBonusBalanceResponse
}
var file_customer_customer_proto_depIdxs = []int32{
	...
	5,  // 8: customer.CustomerService.CreateCustomer:input_type -> customer.CreateCustomerRequest
	11, // 9: customer.CustomerService.DeleteCustomer:input_type -> customer.DeleteCustomerRequest
	9,  // 10: customer.CustomerService.PartialUpdateCustomer:input_type -> customer.PartialUpdateCustomerRequest
	7,  // 11: customer.CustomerService.UpdateCustomer:input_type -> customer.UpdateCustomerRequest
	13, // 12: customer.CustomerService.CreateBonusTransaction:input_type -> customer.CreateBonusTransactionRequest
	4,  // 13: customer.CustomerService.GetCustomer:output_type -> customer.GetCustomerResponse
	6,  // 14: customer.CustomerService.CreateCustomer:output_type -> customer.CreateCustomerResponse
	12, // 15: customer.CustomerService.DeleteCustomer:output_type -> customer.DeleteCustomerResponse
	10, // 16: customer.CustomerService.PartialUpdateCustomer:output_type -> customer.PartialUpdateCustomerResponse
	8,  // 17: customer.CustomerService.UpdateCustomer:output_type -> customer.UpdateCustomerResponse
	14, // 18: customer.CustomerService.CreateBonusTransaction:output_type -> customer.CreateBonusTransactionResponse
