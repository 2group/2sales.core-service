...
func (c *serviceServiceClient) PartialUpdateService(ctx context.Context, in *PartialUpdateServiceRequest, opts ...grpc.CallOption) (*PartialUpdateServiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PartialUpdateServiceResponse)
	err := c.cc.Invoke(ctx, ServiceService_PartialUpdateService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServiceServer) PartialUpdateService(context.Context, *PartialUpdateServiceRequest) (*PartialUpdateServiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PartialUpdateService not implemented")
}
...
func _ServiceService_PartialUpdateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PartialUpdateServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServiceServer).PartialUpdateService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceService_PartialUpdateService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServiceServer).PartialUpdateService(ctx, req.(*PartialUpdateServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServiceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PartialUpdateService",
			Handler:    _ServiceService_PartialUpdateService_Handler,
		},
		{
