...
func (x *PatchUserResponse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type User struct {
	...
	OrganizationId   *int64     `protobuf:"varint,8,opt,name=organization_id,json=organizationId,proto3,oneof" json:"organization_id,omitempty"`
	...
	Role             *RoleModel `protobuf:"bytes,12,opt,name=role,proto3" json:"role,omitempty"`
}
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xf9, 0x01, 0x0a,
	...
	0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c,
	0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x48,
	0x00, 0x52, 0x06, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08,
	0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x22, 0x48, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69,
	...
	0x65, 0x72, 0x22, 0x38, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x4f, 0x0a, 0x12,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x32, 0x0a,
	...
	0x72, 0x22, 0x49, 0x0a, 0x11, 0x50, 0x61, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1e, 0x0a, 0x04,
	0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x75, 0x73, 0x65,
	...
	0x61, 0x73, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x02, 0x52, 0x0c, 0x70, 0x61, 0x73,
	...
	0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x04, 0x52, 0x09, 0x66, 0x69, 0x72, 0x73,
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x20, 0x0a, 0x09, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x05, 0x52, 0x08, 0x6c,
	...
	0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x48, 0x08,
	...
	0x01, 0x01, 0x12, 0x23, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b,
...
var file_user_user_proto_depIdxs = []int32{
	...
	22, // 1: user.RegisterResponse.user:type_name -> user.User
	23, // 2: user.UpdateUserRequest.user:type_name -> user.UserModel
	23, // 3: user.UpdateUserResponse.user:type_name -> user.UserModel
	22, // 4: user.PatchUserRequest.user:type_name -> user.User
	22, // 5: user.PatchUserResponse.user:type_name -> user.User
	22, // 6: user.GetUserResponse.user:type_name -> user.User
	24, // 7: user.CreateRoleResponse.role:type_name -> user.RoleModel
	24, // 8: user.ListRolesResponse.roles:type_name -> user.RoleModel
	24, // 9: user.UpdateRoleResponse.role:type_name -> user.RoleModel
	25, // 10: user.ListPermissionsResponse.permissions:type_name -> user.PermissionModel
	24, // 11: user.User.role:type_name -> user.RoleModel
	25, // 12: user.RoleModel.permissions:type_name -> user.PermissionModel
	0,  // 13: user.UserService.Login:input_type -> user.LoginRequest
	2,  // 14: user.UserService.Register:input_type -> user.RegisterRequest
	4,  // 15: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	6,  // 16: user.UserService.PatchUser:input_type -> user.PatchUserRequest
	8,  // 17: user.UserService.GetUser:input_type -> user.GetUserRequest
	10, // 18: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	12, // 19: user.UserService.CreateRole:input_type -> user.CreateRoleRequest
	14, // 20: user.UserService.ListRoles:input_type -> user.ListRolesRequest
	16, // 21: user.UserService.UpdateRole:input_type -> user.UpdateRoleRequest
	18, // 22: user.UserService.DeleteRole:input_type -> user.DeleteRoleRequest
	20, // 23: user.UserService.ListPermissions:input_type -> user.ListPermissionsRequest
	1,  // 24: user.UserService.Login:output_type -> user.LoginResponse
	3,  // 25: user.UserService.Register:output_type -> user.RegisterResponse
	5,  // 26: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
	7,  // 27: user.UserService.PatchUser:output_type -> user.PatchUserResponse
	9,  // 28: user.UserService.GetUser:output_type -> user.GetUserResponse
	11, // 29: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	13, // 30: user.UserService.CreateRole:output_type -> user.CreateRoleResponse
	15, // 31: user.UserService.ListRoles:output_type -> user.ListRolesResponse
	17, // 32: user.UserService.UpdateRole:output_type -> user.UpdateRoleResponse
	19, // 33: user.UserService.DeleteRole:output_type -> user.DeleteRoleResponse
	21, // 34: user.UserService.ListPermissions:output_type -> user.ListPermissionsResponse
