	...
	router.Route("/api/v1", func(apiRouter chi.Router) {
		...
		apiRouter.Route("/organization", func(orgRouter chi.Router) {
			orgRouter.Group(func(authRouter chi.Router) {
				...
				authRouter.Route("/branch", func(bRouter chi.Router) {
					bRouter.Post("/", organizationHandler.CreateBranch)
					bRouter.Get("/{branch_id}", organizationHandler.GetBranch)
				...
				authRouter.Route("/address", func(aRouter chi.Router) {
					...
					aRouter.Patch("/{address_id}", organizationHandler.PartialUpdateAddress)
		...
		apiRouter.Route("/gift-certificates", func(certificateRouter chi.Router) {
			certificateRouter.Group(func(authRouter chi.Router) {
				...
				authRouter.Get("/labels", giftCertificateHandler.ListGiftCertificateLabels)
				authRouter.Get("/icons", giftCertificateHandler.ListGiftCertificateIcons)
				authRouter.Get("/backgrounds", giftCertificateHandler.ListGiftCertificateBackgrounds)
			})
		})
